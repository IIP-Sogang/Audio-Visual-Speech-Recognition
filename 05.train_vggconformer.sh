...
# ./jw_vggconformer.sh 1


# sed -i 's/jw_sentence_trainval/jw_sentence_noisy_low/g' ./jw_vggconformer.sh
# sed -i 's/MAX_EPOCH=20/MAX_EPOCH=25/g' ./jw_vggconformer.sh
# sed -i 's/LR_SCHEDULER=reduce_lr_on_plateau/LR_SCHEDULER=fixed/g' ./jw_vggconformer.sh
# sed -i 's/LR=1/LR=0.1/g' ./jw_vggconformer.sh
./jw_vggconformer.sh 1

sed -i 's/jw_sentence_noisy_low/jw_sentence_noisy_eq/g' ./jw_vggconformer.sh
sed -i 's/MAX_EPOCH=25/MAX_EPOCH=65/g' ./jw_vggconformer.sh
./jw_vggconformer.sh 1
