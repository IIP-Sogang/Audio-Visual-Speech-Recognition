...
parser.add_argument('--start', type=int, default=39, help='start epoch')
parser.add_argument('--end', type=int, default=50, help='end epoch')
...
#             command = "sh ./WER.sh " + IDX_GPU + " " + ARCH + " " + CODE + " " + "new_test_" + str(snr) + " " + str(epoch) + " " + str(db) + " " + str(args.data) + " " + str(offsets)
#             print(command)
...
for epoch in EPOCH:
    for snr in SNR:
        command = "sh ./WER.sh " + IDX_GPU + " " + ARCH + " " + CODE + " " + "new_test_" + str(snr) + " " + str(epoch) + " " + str(db) + " " + str(args.data) + " " + str(0)
        print(command)
        subprocess.call(command, shell=True)
