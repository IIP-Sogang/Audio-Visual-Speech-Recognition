...
N_BEST=1
BEAM=35
RES_DIR=/home/nas/user/jungwook/DCM_vgg_transformer/result/$TASK/$ARCH/prediction/$CODE
WORD_RES_REPORT=/home/nas/user/jungwook/DCM_vgg_transformer/result/$TASK/$ARCH/{$7}_SNR_TEST/$CODE/$EPOCH/$SET/WER_$CODE
UNIT_RES_REPORT=/home/nas/user/jungwook/DCM_vgg_transformer/result/$TASK/$ARCH/{$7}_SNR_TEST/$CODE/$EPOCH/$SET/CER_$CODE
