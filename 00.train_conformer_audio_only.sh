...
sed -i 's/sentence_pretrain_trainval/sentence_noisy_low/g' ./jw_conformer_audio_only.sh
sed -i 's/MAX_EPOCH=30/MAX_EPOCH=35/g' ./jw_conformer_audio_only.sh
sed -i 's/LR_SCHEDULER=reduce_lr_on_plateau/LR_SCHEDULER=fixed/g' ./jw_conformer_audio_only.sh
sed -i 's/LR=1/LR=0.1/g' ./jw_conformer_audio_only.sh
./jw_conformer_audio_only.sh 1

sed -i 's/sentence_noisy_low/sentence_noisy_eq/g' ./jw_conformer_audio_only.sh
sed -i 's/MAX_EPOCH=35/MAX_EPOCH=75/g' ./jw_conformer_audio_only.sh
./jw_conformer_audio_only.sh 1
