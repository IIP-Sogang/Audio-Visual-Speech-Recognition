...
@register_model("avsr_vggconformer_audio_only_no_position")
...
@register_model_architecture("avsr_vggconformer_audio_only_no_position", "BiModalvggconformer_avsr_audio_only_no_position_base")
