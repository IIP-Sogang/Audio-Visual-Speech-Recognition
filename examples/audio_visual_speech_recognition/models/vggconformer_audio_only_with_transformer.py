...
@register_model("avsr_vggconformer_audio_only_with_transformer")
class VGGConformerModel_audio_only(BaseFairseqModel):
    ...
    def forward(self, audio_src_tokens, audio_src_lengths, video_src_tokens, video_src_lengths, prev_output_tokens, **kwargs):
        ...
        decoder_out = self.decoder(prev_output_tokens, encoder_out=audio_encoder_out, **kwargs)
        return decoder_out
    
    def forward_decoder(self, prev_output_tokens, audio_encoder_outs, video_encoder_outs, incremental_state, **kwargs):
        return self.decoder(prev_output_tokens, audio_encoder_outs, incremental_state, **kwargs)
...
@register_model_architecture("avsr_vggconformer_audio_only_with_transformer", "BiModalvggconformer_avsr_audio_only_with_transformer_1layer")
...
#    args.conv_dec_config = 'None'
    args.transformer_dec_config = getattr(
        args, "transformer_dec_config", "((512, 8, 2048, True, 0.15, 0.15, 0.15),) * 1"
    )
@register_model_architecture("avsr_vggconformer_audio_only_with_transformer", "BiModalvggconformer_avsr_audio_only_with_transformer_1layer_small")
def BiModalvggconformer_avsr_audio_only_base(args):
    args.audio_input_feat_per_channel = getattr(args, "audio_input_feat_per_channel", 90)
    #args.video_input_feat_per_channel = getattr(args, "video_input_feat_per_channel", 512)
    args.audio_vggblock_enc_config = getattr(
...
#    args.conv_dec_config = 'None'
    args.transformer_dec_config = getattr(
        args, "transformer_dec_config", "((144, 8, 576, True, 0.15, 0.15, 0.15),) * 1"
    )
@register_model_architecture("avsr_vggconformer_audio_only_with_transformer", "BiModalvggconformer_avsr_audio_only_with_transformer_3layer")
def BiModalvggconformer_avsr_audio_only_base(args):
    args.audio_input_feat_per_channel = getattr(args, "audio_input_feat_per_channel", 90)
    #args.video_input_feat_per_channel = getattr(args, "video_input_feat_per_channel", 512)
    args.audio_vggblock_enc_config = getattr(
...
@register_model_architecture("avsr_vggconformer_audio_only_with_transformer", "BiModalvggconformer_avsr_audio_only_with_transformer_6layer")
def BiModalvggconformer_avsr_audio_only_base(args):
    args.audio_input_feat_per_channel = getattr(args, "audio_input_feat_per_channel", 90)
    #args.video_input_feat_per_channel = getattr(args, "video_input_feat_per_channel", 512)
    args.audio_vggblock_enc_config = getattr(
