...
@register_model("avsr_vggconformer_norm_DCM")
...
@register_model_architecture("avsr_vggconformer_norm_DCM", "BiModalvggconformer_avsr_norm_DCM_base")
...
#    args.video_vggblock_enc_config = 'None'
    args.conformer_enc_config = getattr(
        ...
        # args, "conformer_enc_config", "((512, 64, 8, 4, 2, 31, 0.1,0.1,0.1,512),) * 3"
        # args, "conformer_enc_config", "((256, 32, 8, 4, 2, 32, 0.1,0.1,0.1,256),) * 12"
    )
