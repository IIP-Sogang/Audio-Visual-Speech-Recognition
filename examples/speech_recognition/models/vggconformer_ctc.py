...
@register_model("libri_vggconformer_ctc")
class VGGConformerModel_audio_only(BaseFairseqModel):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, **kwargs):
        ...
        decoder_out = self.decoder(encoder_out=audio_encoder_out,**kwargs)
        return decoder_out

    def forward_decoder(self, audio_encoder_outs, **kwargs):
        return self.decoder(audio_encoder_outs, **kwargs)
...
class VGGCTCDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(
        ...
        self.fc_out = Linear(encoder_output_dim, vocab_size)
    ...
    def forward(self,encoder_out=None, incremental_state=None):
        
        x = encoder_out["encoder_out"]
        y = self.fc_out(x)
        y = y.permute(1,0,2)
        return y, encoder_out["encoder_padding_mask"],None
...
@register_model_architecture("libri_vggconformer_ctc", "libri_vggconformer_ctc_base")
