...
@register_model("libri_vggtransformer_audio_only")
class VGGTransformerModel_audio_only(BaseFairseqModel):
    """
    ...
    def forward_decoder(self, prev_output_tokens, audio_encoder_outs, incremental_state, **kwargs):
...
@register_model_architecture("libri_vggtransformer_audio_only", "libir_vggtransformer_audio_only_base")
def BiModalvggtransformer_avsr_audio_only_base(args):
