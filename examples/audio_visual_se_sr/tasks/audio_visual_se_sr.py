...
@register_task("audio_visual_se_sr")
class AVSpeechRecognitionTask2(FairseqTask):
    """
    ...
    def build_generator(self, args):
        if getattr(args, 'score_reference', False):
            ...
            from examples.audio_visual_se_sr.tasks.sequence_generator import SequenceGenerator, SequenceGeneratorWithAlignment
