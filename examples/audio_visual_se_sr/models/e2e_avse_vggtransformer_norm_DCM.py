...
@register_model("e2e_avse_avsr_vggtransformer_norm_DCM")
class e2e_avse_avsr_VGGTransformerModel_norm_DCM(BaseFairseqModel):
    """
    ...
    def __init__(self,avse,avsr):
        ...
        # pdb.set_trace()
        self.unet = avse
        # self.unet = torch.load("avse_model/new_AVSE.pth")
...
@register_model_architecture("e2e_avse_avsr_vggtransformer_norm_DCM", "e2e_BiModalvggtransformer_avse_avsr_norm_DCM_base")
