...
@register_model("avse_avsr_vggtransformer")
class avse_avsr_VGGTransformerModel(BaseFairseqModel):
    """
...
@register_model_architecture("avse_avsr_vggtransformer", "BiModalvggtransformer_avse_avsr_base")
