...
sed -i 's/new_sentence_noisy_low/new_sentence_noisy_eq/g' ./jw_avse_avsr_transformer_norm_ce.sh
sed -i 's/MAX_EPOCH=25/MAX_EPOCH=65/g' ./jw_avse_avsr_transformer_norm_ce.sh
./jw_avse_avsr_transformer_norm_ce.sh 1
