...
DIR_FOR_PREPROCESSED_DATA=/home/nas/DB/[DB]_for_fairseq/[DB]_LRS_con/preprocessed_data/character/LRS3_sentence_SNR 
...
MAX_EPOCH=100
NUM_WORKERS=20
ARCH=BiModalvggconformer_avsr_video_only_base
CODE=VGG_base_wi_conformer_CE_512_6_6_original_routine
