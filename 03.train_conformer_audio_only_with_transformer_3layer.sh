...
sed -i 's/sentence_pretrain_trainval/new_sentence_noisy_low/g' ./jw_conformer_audio_only_with_transformer_3layer.sh
sed -i 's/MAX_EPOCH=30/MAX_EPOCH=35/g' ./jw_conformer_audio_only_with_transformer_3layer.sh
sed -i 's/LR_SCHEDULER=reduce_lr_on_plateau/LR_SCHEDULER=fixed/g' ./jw_conformer_audio_only_with_transformer_3layer.sh
sed -i 's/LR=1/LR=0.1/g' ./jw_conformer_audio_only_with_transformer_3layer.sh
./jw_conformer_audio_only_with_transformer_3layer.sh 1

sed -i 's/new_sentence_noisy_low/new_sentence_noisy_eq/g' ./jw_conformer_audio_only_with_transformer_3layer.sh
sed -i 's/MAX_EPOCH=35/MAX_EPOCH=75/g' ./jw_conformer_audio_only_with_transformer_3layer.sh
./jw_conformer_audio_only_with_transformer_3layer.sh 1
