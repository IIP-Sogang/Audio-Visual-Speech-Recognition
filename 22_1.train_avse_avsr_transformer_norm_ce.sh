...
./jw_avse_avsr_transformer_norm_ce_1.sh 1

sed -i 's/new_sentence_noisy_low/new_sentence_noisy_eq/g' ./jw_avse_avsr_transformer_norm_ce_1.sh
sed -i 's/MAX_EPOCH=5/MAX_EPOCH=15/g' ./jw_avse_avsr_transformer_norm_ce_1.sh
./jw_avse_avsr_transformer_norm_ce_1.sh 1
