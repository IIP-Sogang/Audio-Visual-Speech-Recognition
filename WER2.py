...
parser.add_argument('--start', type=int, default=60, help='start epoch')
...
# SNR=['clean']
SNR=['20dB','15dB','10dB','5dB','0dB','m5dB']
st=args.start
ed=args.end
...
if args.vid_off == 1:
    ...
    for epoch in EPOCH:
        for snr in SNR:
            ...
            command = "sh ./WER2.sh " + IDX_GPU + " " + ARCH + " " + CODE + " " + "test_" + str(snr) + " " + str(epoch) + " " + str(db) + " " + str(args.data) + " " + str(offsets)
            print(command)
...
for epoch in EPOCH:
    for snr in SNR:
        command = "sh ./WER2.sh " + IDX_GPU + " " + ARCH + " " + CODE + " " + "Kaldi_SE_test_" + str(snr) + " " + str(epoch) + " " + str(db) + " " + str(args.data) + " " + str(0)
        print(command)
        subprocess.call(command, shell=True)
